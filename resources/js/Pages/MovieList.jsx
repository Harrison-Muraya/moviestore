...
function MovieList() {
    ...
    return (
        <>
            <div className="fixed inset-0 overflow-hidden bg-[url('/images/silence.jpg')]  h-screen bg-cover bg-center bg-no-repeat">
                                        ...
                                        <li key={index} className="text-white text-lg bg-black/40 backdrop-blur-sm md:text-2xl p-2 my-6 font-semibold tracking-wider rounded-sm">
                                            <div className="grid grid-cols-2">
                                                ...
                                                <div className="flex items-center justify-center">
                                                    <span className="text-red-600 text-lg md:text-2xl font-bold">{movie.title}</span>
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-2">
                                                <div className="w-16 h-16 md:w-40 md:h-40">
